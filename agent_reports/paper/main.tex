...
\textbf{(C) VLM-CF and verified-CF sweeps (Phase~2) --- not yet launched.}
18 additional runs on Modal (VLM-CF with \texttt{gpt-4o-mini} +
verified-CF with the N1 simulator gate) were to launch after Phase~1
completion. They have not yet launched: a prior HER sweep is currently
holding all 10 Modal GPU slots, and the orchestrator is correctly waiting
on free capacity. These runs will provide ablation evidence for the
verifier mechanism in the camera-ready, regardless of whether they show a
training-time benefit beyond the kill-verdict envelope established here.
