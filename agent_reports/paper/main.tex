...
than absolute SR) is the load-bearing claim. A 1\,M-step HER reference run,
currently in flight, will close part of the absolute gap; its preliminary
\texttt{FetchPickAndPlace} value is $0.40$ mean over $n\!=\!2$ seeds vs.\
$0.18$ at 250\,k, consistent with the convex shape of canonical learning
curves at the matched-step regime.
...
\textbf{(F) Mid-training trajectory of Oracle-CF at 1\,M steps --- preliminary observation.}
