...
\citet{pignatelli2024calm} show that an LLM can serve as a zero-shot credit
oracle via subgoal decomposition in text-based environments---confirming
foundation-model-as-credit-oracle as a direction beyond our domain.
\emph{Our semantic-PER introduces an exogenous foundation-model credit-assignment
oracle}: pre-trained on web-scale data, queried zero-shot at episode granularity,
combined with verifiable counterfactual hindsight as the acceptance gate.
This is a strictly stronger framing than ``VLM in replay'' and places our
contribution inside the emerging causal-credit-assignment family rather
than the reward-shaping family.
