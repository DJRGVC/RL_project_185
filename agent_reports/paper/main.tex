...
IS-correction analysis; the additive mixture of the concurrent VLM-RB
...
buffer (confidence~1.0, zero modeling error). A two-vendor, three-model prompt sweep
...
uncommitted ($w_{\max}\!=\!1$), needs no $\lambda$-warm-up, and supports a
